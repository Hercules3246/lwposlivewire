            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="text-center"><span class="brand-name"><b>MQPOS</b></span></h1>
                        ...
                        <form class="text-left mt-5" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form" >
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="correo@gmail.com" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
...
<!--
                    ...
                    <p class="terms-conditions text-center">© 2022 All Rights Reserved. <a href="#" target="_blank">MIGUELQUINTERO</a> <br>versión 1.0 </p>
